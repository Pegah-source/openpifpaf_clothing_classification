...
# I have this error in the hflip of the pifpaf that seems to say 
...
class DeepfashionDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        anns[0]['object_type'] = DeepfashionType.Clothing
        ...
        meta = {
            'dataset': 'deepfashion',
            'image_category' : anns[0]['category_id'],
            'dataset_index': index,
            'image_id': image_id,
        ...
        # TODO: 
        # add the annotation for the category of images
        # and consider it as an extra 
